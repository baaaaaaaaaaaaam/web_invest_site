...
$mail->Username = "Your Email"; // Gmail 계정
$mail->Password = "Your Email Password"; // 패스워드
$mail->SetFrom('ansgyqja@naver.com', '문효범입니다'); // 보내는 사람 email 주소와 표시될 이름 (표시될 이름은 생략가능)
...
$mail->Subject = 'kiwoom_daily_report 입니다 '; // 메일 제목
$mail->Body =
"키움증권 데일리 리포트 입니다.";
...
$file_name='/var/www/html/invest_crawler/'.$file_name;
// echo $file_name;
mysqli_close($conn);
